...
console.log("Legacy Supabase runtime sources removed from normal UI; admin preview projects Business UI without changing actual billing/usage, plan/admin/prefs use Worker+D1+Clerk, feedback uses Feedback Hub, and old Supabase admin mutations are disabled.");
