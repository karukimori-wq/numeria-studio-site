...
assert.match(workerSource, /Selectable appraisal client profile chips/);
assert.match(workerSource, /Editable saved appraisal client profiles/);
...
assert.match(dashboardSource, /client-profile-list/);
