...
assert.match(originalHtml, /authRedirectUrl/);
assert.match(originalHtml, /\/sign-up/);
assert.match(originalHtml, /\/sign-in/);
assert.match(originalHtml, /window\.location\.assign/);
assert.match(originalHtml, /email_address/);
